      ...
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div className="relative px-4 py-10 bg-white shadow-lg rounded-3xl sm:p-20">
          <h1 className="text-2xl font-bold mb-4">
            Image-to-Recipe & Image Generation
          </h1>
          
          <div className="flex mb-4">
            <button
              onClick={() => setActiveTab('upload')}
              className={`font-bold py-2 px-4 rounded ${activeTab === 'upload' ? 'bg-purple-500 hover:bg-purple-700 text-white' : 'text-purple-500'}`}
            >
              Upload Image
            </button>
            ...
            <button
              ...
              className={`font-bold py-2 px-4 rounded ml-4 ${activeTab === 'generate' ? 'bg-purple-500 hover:bg-purple-700 text-white' : 'text-purple-500'}`}
            >
              Generate Image
            </button>
          </div>
          ...
          {activeTab === 'upload' ? (
            <div>
              <p className="mb-4">
                Upload an image to get a recipe and nutritional information based on the image's content.
              </p>
